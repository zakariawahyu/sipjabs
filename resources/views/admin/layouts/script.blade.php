...
<script>
  $("#datatablejabstruk").DataTable({
    ...
    columns: [
      ...
      {data: 'formasi_jabatan', name: 'formasi_jabatan'},
      {data: 'action', name: 'action'},
    ]
  })
</script>
