        ...
        <div class="">
          ...
          <div class="row">
            ...
            <div class="col-md-8 col-sm-12 col-xs-12">
              <a href="{{ route('admin.profile.show', Auth::user()->id) }}" class="btn btn-danger pull-right btn-reset-admin" title="Reset Password"><i class="fa fa-key"></i> Reset Password</a>
              <a href="{{ route('admin.profile.edit', Auth::user()->id) }}" class="btn btn-info pull-right btn-edit-admin" title="Edit Profile"><i class="fa fa-edit"></i> Edit Profile</a>
              <div class="x_panel">
                <div class="x_title">
                  <h2>Profilku</h2>
