                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          <a href="{{ route('admin.tallent.show', $tl->id) }}" class="btn btn-info btn-show-tallent-admin" title="Nomor Surat {{ $tl->nomor_surat }}"><i class="fa fa-eye"></i> View</a>
                          <a href="{{ route('admin.tallent.delete', $tl->id) }}" class="btn btn-danger"><i class="fa fa-trash"></i> Delete</a>
                          <a href="{{ route('admin.tallent.cetak', $tl->id) }}" class="btn btn-primary"><i class="fa fa-print"></i> Print PDF</a>
                        </td>
                      </tr>  
                      @endforeach
